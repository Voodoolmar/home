...
declare namespace ReactRouterRedux {
    ...
    function routerReducer<TRootState>(state?: TRootState, options?: any): R.Reducer<TRootState>;
    function syncHistoryWithStore<TRootState>(history: H.History, store: R.Store<TRootState>, options?: SyncHistoryWithStoreOptions): ReactRouterReduxHistory;
