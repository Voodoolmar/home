...
var MCP23017 = (function () {
  ...
  */
  ...
  MCP23017.prototype.digitalReadARegister = function (callback) {
    var register = FROM_GPIOA;
    this._read(register, 1, function (err, registerValue) {
      if (err) {
        console.error(err);
        callback(err, null);
  ...
  MCP23017.prototype.digitalReadBRegister = function (callback) {
    var register = FROM_GPIOB;
    this._read(register, 1, function (err, registerValue) {
      if (err) {
        console.error(err);
        callback(err, null);
